  ...
  Widget build(BuildContext context) {
    return new ListView.builder(itemBuilder: (context,index){
        ...
        return GestureDetector(child: new Card(margin: const EdgeInsets.only(left: 10.0,top: 10.0,right: 10.0,bottom: 0.0),
          color: Colors.white,
          elevation: 10.0,
          child: new Container(padding: const EdgeInsets.all(10.0),child: new Row(children: <Widget>[new Expanded(child: new Column(crossAxisAlignment: CrossAxisAlignment.start,children: <Widget>[Text("这是标题",style: TextStyle(color: Colors.black,fontSize: 18.0),),new Flow(delegate: MyFlowDelegate(),children: <Widget>[Text("yyyy")],)],)),Icon(Icons.keyboard_arrow_right)],
